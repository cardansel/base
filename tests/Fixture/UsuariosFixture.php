...
class UsuariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'usuario' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_Usuarios_Personas_idx' => ['type' => 'index', 'columns' => ['Personas_id'], 'length' => []],
            'fk_Usuarios_Perfiles1_idx' => ['type' => 'index', 'columns' => ['Perfiles_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_Usuarios_Perfiles1' => ['type' => 'foreign', 'columns' => ['Perfiles_id'], 'references' => ['perfiles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_Usuarios_Personas' => ['type' => 'foreign', 'columns' => ['Personas_id'], 'references' => ['personas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'Personas_id' => 1,
                'Perfiles_id' => 1,
                'create' => '2018-06-29 19:35:33',
                'modified' => '2018-06-29 19:35:33'
            ],
        ];
        parent::init();
    }
